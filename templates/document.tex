...
\renewenvironment{verbatim}%
  {\VerbatimEnvironment\begin{Verbatim}[fontsize=\small, frame=single,
    rulecolor=\color{border}, breaklines=true, breakanywhere=true]}%
  {\end{Verbatim}}
...
\renewcommand{\maketitle}{%
  ...
  \begin{center}
    $if(subtitle)$
    {\sffamily\fontsize{12pt}{14pt}\selectfont\color{scenelabel}$subtitle$\par}
    \vspace{6mm}
    $endif$
