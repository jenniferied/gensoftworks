...
| ~~Wie triggert das Lymph-Subsystem die PP-Stufen?~~ | Darius | ~~Hoch~~ | **ERLEDIGT** (Tag 3): Interface-Spezifikation in 6.4.7 |
| Welche Sichtachsen / Constraint-Punkte für Houdini-Terrain? | Vera / Emre | Hoch | Offen — wartet auf Topos-Kapitel |
| Braucht Fraktionswahl in Stunde 1 unterschiedliche PP-Presets? | Nami | Mittel — vor Beta | Offen — optionale Erweiterung in 6.4.7 vorskizziert |
...
| Orden-Kreuz-Vektor für Shader-Texture-Atlanten | Vera | Mittel — sobald Art-Direction entschieden | Offen — ich brauche ein fixes Vektorbild |

---

*Dokument-Status*: Version 3.0. Schwellenanker-Rename vollständig durchgezogen. Vera-Schichtgrenzen-Frage als erledigt markiert. Interface-Spezifikation Lymph → PP-Trigger (6.4.7) als neuer Abschnitt ergänzt — Darius' Blocker ist damit adressiert. Sichtbarer Text bereinigt: keine Autorennamen mehr im Fließtext.
