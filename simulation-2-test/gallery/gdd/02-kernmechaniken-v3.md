...
- V3 (Tag 6, Szene 5): Suchtmechanik überarbeitet nach Leo-Balancing-Feedback — nur Combat-Buffs suchtfähig (expliziter Ausschluss aller anderen Kategorien), Toleranz-Schwelle von Quest-basiert auf 3 Anwendungen/24 Spielstunden umgestellt, Konsequenz von Materialkosten-Erhöhung/Totalverlust auf sinkende Wirkungsdauer geändert
...
### 4.3 Suchtmechanik bei Combat-Buffs (V3 — überarbeitet nach Leo-Balancing-Feedback)

> V2-Ergänzung: Die offene Frage aus V1 ("Suchtmechanik: Haben Combat-Buffs Nebenwirkungen bei Überkonsum?") wurde in V2 beantwortet. V3 präzisiert das System nach Leos Balancing-Feedback in drei Punkten: (1) klarer Scope -- NUR Combat-Buffs, (2) zeitbasierte Toleranz-Schwelle statt Quest-basierter Zählung, (3) sinkende Wirkungsdauer statt Materialkosten-Erhöhung oder Totalverlust.

**Grundprinzip (unverändert):** Das Briefing nennt "Echte Drogen, Amphetamine" als Designrichtung. Alchemie-Buffs sind in dieser Welt keine harmlosen Power-Ups — sie sind Eingriffe in Emer-Material, und der Körper reagiert darauf. Aber: Die Suchtmechanik darf den Spieler nie in eine Abwärtsspirale treiben, aus der er nicht mehr herauskommt. Sie ist ein Werkzeug zur Risikobewertung, kein Bestrafungsinstrument.

**Scope-Abgrenzung (V3 — Leo-Feedback Punkt 1):**

Die Suchtmechanik greift AUSSCHLIESSLICH bei **Combat-Buffs** (Waffenöle, Reflexelixier, Stärketrank und vergleichbare kampfverstärkende Alchemie-Produkte). Alle anderen Produktkategorien sind NICHT suchtfähig:

| Kategorie | Suchtfähig? | Begründung |
|-----------|-------------|------------|
| **Combat-Buffs** | JA | Leistungssteigernde Substanzen greifen direkt ins Emer-Material ein -- der Körper gewöhnt sich daran. Das ist die Spieler-Fantasie: "Doping hat Konsequenzen." |
| **Heilung** | NEIN | Heiltränke stellen wieder her, sie verstärken nicht. Der Körper wird nicht abhängig von seiner eigenen Regeneration. |
| **Schattenfieber-Kontrolle** | NEIN | Suppressiva und Stabilisatoren sind medizinische Notwendigkeit -- Sucht bei Medikamenten würde eine Bestrafungsspirale erzeugen, die Bedingung 2 (Power Fantasy) verletzt. |
| **Gifte** | NEIN | Gifte werden auf Waffen appliziert, nicht vom Spieler konsumiert. Kein körperlicher Gewöhnungseffekt. |
| **Utility** | NEIN | Nachtsicht, Atem-Verlängerung etc. sind Werkzeuge, keine Leistungsverstärker. Sucht hier wäre Bestrafung für Exploration -- das widerspricht der Kernfantasie. |
| **Schutz** | NEIN | Schutz-Präparate sind die Lebensversicherung für Stufe-0-Spieler. Sucht hier würde den Stufe-0-Spielpfad sabotieren (QA-Veto). |

**Mechanik — Toleranz-System (V3 — überarbeitet):**

> V3-Änderung: Die Zähleinheit wechselt von "pro Quest" auf "pro 24 Spielstunden". Leos Argument: Quest-Längen variieren stark -- eine 30-Minuten-Quest und eine 4-Stunden-Quest dürfen nicht denselben Toleranz-Zähler haben. Spielzeit ist die fairere, vorhersagbarere Metrik. Die Toleranz-Schwelle liegt bei 3 Anwendungen pro 24-Stunden-Fenster.

| Konsum (pro 24 Spielstunden) | Effekt | Spieler-Erfahrung |
|------------------------------|--------|-------------------|
| **Unter Schwelle** (1-3 Anwendungen) | Volle Wirkung, volle Wirkungsdauer, keine Nebenwirkungen | "Dieses Zeug ist gut. Ich nutze es taktisch, wenn ich es brauche." |
| **Über Schwelle** (4-6 Anwendungen) | Volle Wirkungsstärke, aber **sinkende Wirkungsdauer**: jede weitere Anwendung über der Schwelle verkürzt die Buff-Dauer um 20% | "Der Trank wirkt noch -- aber kürzer. Lohnt sich ein fünfter?" |
| **Deutlich über Schwelle** (7+ Anwendungen) | Volle Wirkungsstärke, Wirkungsdauer auf **Minimum 30%** der Basis gekappt, temporäre Nacheffekte: Cardio-Malus nach Abklingen (30 Sekunden Ausdauer-Reduktion) | "Ich kriege noch einen Kick -- aber er vergeht schnell, und danach bin ich kurz langsamer." |

**Sinkende Wirkungsdauer statt Totalverlust (V3 — Leo-Feedback Punkt 3):**

Das V2-Modell arbeitete mit steigenden Materialkosten als Hauptkonsequenz. Leos Feedback: Materialkosten bestrafen primär Exploration-Spieler (die sowieso mehr Zutaten finden) und treffen Combat-fokussierte Spieler unverhältnismäßig hart. Die neue Konsequenz -- sinkende Wirkungsdauer -- ist direkter und intuitiver:

- Der Buff wird NICHT schwächer (keine Reduktion der Wirkungsstärke). Ein Stärketrank gibt immer denselben Schadensbonus.
- Der Buff hält nur KÜRZER an. Der Spieler muss entscheiden: Investiere ich eine weitere Dosis für einen kürzeren Effekt -- oder warte ich, bis der Toleranz-Zähler zurücksetzt?
- Es gibt KEINEN Totalverlust. Selbst bei exzessivem Konsum bleibt die Wirkungsdauer bei mindestens 30% der Basis. Der Trank tut immer noch etwas.
- Die Nacheffekte (Cardio-Malus bei 7+ Anwendungen) sind temporär (30 Sekunden) und nicht kumulativ.

**Was Sucht NICHT ist (unverändert, präzisiert):**
...
- KEINE versteckte Mechanik — der Spieler sieht im Tooltip: "Toleranz: 3/3 (24h). Nächste Anwendung: Wirkungsdauer -20%."
...
- KEINE Anwendung auf Utility-Tränke, Heilung, Gifte, Schutz oder Schattenfieber-Kontrolle.

**Was Sucht IST (V3 — aktualisiert):**
- Ein TEMPO-Werkzeug: Sinkende Wirkungsdauer erzwingt taktisches Timing — der Spieler muss den Buff-Einsatz auf den entscheidenden Moment konzentrieren, statt sich dauerhaft zu buffen.
- Ein RISK/REWARD-System: Mehr Konsum = kürzere Fenster. Der Spieler, der seinen Stärketrank im richtigen Moment nimmt, wird genauso belohnt wie der, der ihn dauernd schluckt — aber der zweite muss öfter nachlegen.
...
**Toleranz zurücksetzen (V3 — überarbeitet):**
- Der Toleranz-Zähler ist ein rollendes 24-Spielstunden-Fenster. Anwendungen, die länger als 24 Spielstunden zurückliegen, fallen automatisch heraus.
- Lymph-Ast-Investition beschleunigt den Toleranz-Abbau (bei Lymph-Stufe 5+: Fenster verkürzt sich auf 18 Spielstunden; bei Stufe 8+: 12 Spielstunden)
- Kein "Reset-Trank" — der Körper braucht Zeit, nicht Alchemie

**Interaktion mit Schattenfieber (unverändert):**
- Infizierte Spieler (Zone Rauschen+) haben eine HÖHERE Grundtoleranz — ihr Emer-Material ist bereits aktiviert, also reagiert es weniger stark auf Alchemie-Buffs. Vorteil: Toleranz-Schwelle bei 4 statt 3 (Zone Rauschen), 5 (Zone Risse), 6 (Zone Schwelle). Nachteil: Alchemie wirkt generell schwächer (Lymph-Malus durch Infektion).
...
- **Suchtmechanik:** Toleranz verkürzt Wirkungsdauer bei Combat-Buffs → taktisches Timing wird belohnt → Lymph-Ast-Investition als Gegenmaßnahme
...
- [x] ~~Suchtmechanik~~ → Gewöhnungs-System definiert (V2), Toleranz-Balancing überarbeitet (V3, Leo-Feedback)
...
ALCHEMIE <-> SCHATTENFIEBER
  ...
  Toleranz-System: Sinkende Wirkungsdauer bei Combat-Buff-Überkonsum (V3)
...
- Toleranz-System: Sinkende Wirkungsdauer statt Bestrafungsspirale; Schwelle zeitbasiert (24h), nicht Quest-basiert (Leo-Feedback V3); Leo-Veto bei Verletzung des Grundprinzips
...
| Toleranz-System wird als Bestrafung gelesen | NIEDRIG (V3, vorher MITTEL) | Niedrig (V3, vorher Mittel) | Transparenz (Tooltip: "Toleranz: 3/3"), kein Totalverlust (min. 30% Dauer), keine Anwendung auf Utility/Heilung/Schutz, Leo-Veto |
...
| Suchtmechanik: Leo-Balancing-Feedback einarbeiten | Darius + Leo | Tag 6, Szene 5 | ERLEDIGT (V3) |
...
*Darius Engel, Game Design Corner, Tag 6 (Montag) — V3*
*"Macht es Spaß? Was ist die Spieler-Fantasie hier?" — V3: Leos Balancing-Feedback zur Suchtmechanik eingearbeitet. Scope klar abgegrenzt (nur Combat-Buffs), Toleranz-Schwelle auf Spielzeit umgestellt (3/24h), Konsequenz auf sinkende Wirkungsdauer geschärft. Kein Totalverlust, kein Utility-Nerf. Das System belohnt taktisches Timing, statt Exploration zu bestrafen.*
