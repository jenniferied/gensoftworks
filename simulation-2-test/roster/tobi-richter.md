...
commute: Auto (Toyota Yaris Hybrid), 18 min
background: deutsch, Mittelschicht, TH OWL Alumnus
---
...
- **2 Jahre in Seoul, Südkorea** — arbeitete für XRIS Studio, ein Virtual-Production-Unternehmen
  - Baute LED-Volume-Environments für koreanische Drama-Produktionen und Werbedrehs. Lernte Unreal Engine auf Produktions-Pipeline-Tiefe. Sammelte basales Koreanisch. Entdeckte, dass Real-Time-Rendering ganze VFX-Pipelines ersetzen kann.
  - Hier lernte er Yuki kennen.
  - Ging, weil er Inhalte machen wollte, nicht nur die Tools für Inhalte anderer Leute.

- **Zurück in Deutschland**: 8 Monate bei einem VP-Startup in München, Real-Time-Environments für eine Netflix-Produktion (Name unter NDA)
  - Erkannte, dass Film-VP Unreal immer als "schicken Greenscreen-Ersatz" behandeln würde. Er wollte Welten bauen, in denen Leute LEBEN, nicht nur hinschauen.
  - Als die Idee für ein eigenes Studio aufkam, wusste er sofort: Detmold/Lemgo. Er kannte die Region, die Förderlandschaft, die TH OWL. Er war es, der den Kontakt zum Kreis Lippe herstellte und die Bewerbung für das Hobart-Areal schrieb.

- **Kein formaler MA** — Industrieerfahrung spricht lauter. Überlegt gelegentlich einen berufsbegleitenden Master in Technical Direction, aber keine Zeit. Hat noch Alumni-Zugang zu den TH-OWL-Werkstätten.
