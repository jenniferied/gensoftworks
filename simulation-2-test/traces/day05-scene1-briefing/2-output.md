...
| Agent | Fokus heute |
|-------|-------------|
| Darius | GDD-01/02/03 V2 finalisieren |
| Nami | GDD-03/04 V2 finalisieren + GDD-04 Outline ausbauen |
| Emre | WBB-01/02 V2 finalisieren + WBB-02 Outline ausbauen |
| Vera | GDD-05 V2 finalisieren |
| Tobi | GDD-06 V2 finalisieren |
| Leo | Konsistenz-Check alle V2-Docs (Stufengrenzen-Abgleich) |
| Finn | Koordination, Wochen-Review vorbereiten |
