...
![Szene 1](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-001-scene-001-BRIEFING.png){ width=100% }
...
![Szene 2](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-001-scene-002-WORK.png){ width=100% }
...
![Szene 3](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-001-scene-003-MEETING.png){ width=100% }
...
![Szene 5](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-001-scene-005-WORK.png){ width=100% }
...
![Szene 1](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-002-scene-001-BRIEFING.png){ width=100% }
...
![Szene 2](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-002-scene-002-WORK.png){ width=100% }
...
*Artefakt: `01-spieluebersicht.md`*

*Artefakt: `02-kernmechaniken.md`*

*Artefakt: `03-erzaehlkonzept.md`*
...
![Szene 3](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-002-scene-003-MEETING.png){ width=100% }

Standup Tag 2. Alle sieben berichten Vormittags-Ergebnisse: Saemtliche V1-Outlines stehen (WBB-01, GDD-01 bis -03, GDD-05, GDD-06). Finn verteilt fuenf CD-Entscheidungen: (1) Keine buchstaeblichen Goetter in der Spielwelt, die Frage bleibt offen, (2) Eigenes Namenssystem fuer RELICS-Kosmologie, nordische Namen nur als Entwickler-Referenz, (3) Das Relikt ist eine lebende Krone — ein Biotech-Artefakt aus der Ur-Bindung, das die Membran zwischen den Schichten stabilisiert, (4) Widerspruchs-Log #004 ist gewollt — Biotech-Forschung ist gefaehrlich und Kern des Ordens-Geheimnisses, (5) Tod beeinflusst den Infektionswert nicht — Schattenfieber ist permanent und unabhaengig. Emre bringt neue Fragen ein (Goetter, Namenssystem), Darius praesentiert Combat als 3-Schichten-Spektrum mit 14 offenen Design-Fragen, Nami braucht das Relikt fuer die Hauptquest und Stufen-Mapping mit Darius. Vera hat Emres Orden-Symbolik erhalten. Leo liefert QA-Risikomatrix mit 40% Fokus auf Schattenfieber und drei nicht-verhandelbaren Bedingungen fuer Irreversibilitaet. Nachmittags-Auftraege verteilt: Darius+Leo QA-Schleife, Emre+Nami Stufen-Mapping und Relikt, Vera integriert Orden-Symbolik, Tobi ergaenzt Schattenfieber-Tech, Finn finalisiert Produktionsplan.

*Artefakt: `01-mythos.md (Outline V1)`*

*Artefakt: `01-spieluebersicht.md (Outline V1)`*

*Artefakt: `02-kernmechaniken.md (Outline V1)`*

*Artefakt: `03-erzaehlkonzept.md (Outline V1)`*
...
![Szene 4](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-002-scene-004-PAUSE.png){ width=100% }

Bilaterale Mittagspause. Nami und Emre besprechen die drei neuen CD-Entscheidungen: (1) Lebende Krone als Relikt — eingeordnet als Schlussstein des Drei-Schichten-Modells, die Krone haelt die Membran aktiv aufrecht. Narrativ: Hauptquest fuehrt zur Traeger-Entscheidung, drei Fraktions-Ansprueche plus moegliches viertes Ende (Verweigerung). (2) Stufen-Mapping konsolidiert: Rauschen (Stufe 1-2, subtile Stoerungen), Risse (Stufe 3-4, unuebersehbare Verzerrungen), Schwelle (Stufe 5, qualitativer Zustandswechsel — Membran faellt fuer den Betroffenen). Kein HUD-Indikator fuer Halluzinationen. Vorschlag geht bilateral an Darius. (3) Eigenes Namenssystem: linguistisches Prinzip vereinbart — gemeinsamer Wortstamm mit fraktionsbedingter Lautverschiebung. Arbeitsnamen-Liste (6-8 Kernbegriffe) als Nachmittagsaufgabe. Zusaetzlich: Keine buchstaeblichen Goetter (bestaetigt), Voelva/Seherin als frueher NPC-Kontakt nach Malkavian-Prinzip (prophetisch, nicht verrueckt). Stimmung still, warm, konzentriert.
...
![Szene 5](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-002-scene-005-WORK.png){ width=100% }
...
![Szene 1](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-001-BRIEFING.png){ width=100% }
...
![Szene 2](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-002-WORK.png){ width=100% }
...
*Artefakt: `01-spieluebersicht.md (V1)`*
...
![Szene 3](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-003-MEETING.png){ width=100% }

Standup nach dem ersten Produktions-Vormittag. Vier V1-Dokumente fertig: WBB-01 Mythos (Emre), GDD-01 Spieluebersicht (Darius), GDD-05 Designsprache (Vera), GDD-06 Technik (Tobi). Emre hat die Deadline gehalten — Kapitel 1-4 als Fliesstext, eigenes Namenssystem durchgehend. Widerspruchs-Log #005 (Schattenfieber-Kosmologie vs. Mechanik) geloest. Darius hat sechs Design-Saeulen mit Validierungstests. Vera liefert zehn Kapitel mit Hex-Codes und Fraktionsvisuals. Tobi hat das Budget (45k EUR) aufgeteilt und den kritischen Pfad definiert. Leo arbeitet am QA-Querlesen aller Dokumente. Nami plant nachmittags GDD-03 Erzaehlkonzept V1 auf Basis von Emres WBB-01. Nachmittags-Auftraege: Nami schreibt GDD-03 V1, Darius finalisiert GDD-02 V1 Kernmechaniken, Leo schreibt Spielerperspektiv-Bericht und QA-Kommentare in alle Dokumente, Peer-Reviews laufen parallel.
...
![Szene 4](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-004-PAUSE.png){ width=100% }
...
![Szene 5](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-005-WORK.png){ width=100% }
...
*Artefakt: `03-erzaehlkonzept.md (V1)`*
...
![Szene 6](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-003-scene-006-REVIEW.png){ width=100% }
...
![Szene 2](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-004-scene-002-WORK.png){ width=100% }
...
![Szene 4](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-004-scene-004-PAUSE.png){ width=100% }
...
![Szene 5](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-004-scene-005-WORK.png){ width=100% }
...
![Szene 6](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-004-scene-006-DND.png){ width=100% }
...
![Szene 1](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-005-scene-001-BRIEFING.png){ width=100% }
...
![Szene 3](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-005-scene-003-MEETING.png){ width=100% }
...
![Szene 4](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-005-scene-004-PAUSE.png){ width=100% }
...
![Szene 5](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-005-scene-005-WORK.png){ width=100% }
...
![Szene 6](/var/folders/fr/y30bxq454jxb7bycr3yh9gmw0000gn/T/logbook-crop-tr41bczx/day-005-scene-006-REVIEW.png){ width=100% }
